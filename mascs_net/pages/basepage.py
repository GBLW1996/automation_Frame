...
from mascs_net.common.cappic import Cappic
from mascs_net.common.log import Logger
from mascs_net.common.warning import message
...
class BasePage(object):
    ...
    def start_browser(self):
        mylogger.info("马鞍山慈善网自动化测试开始")
        url = "http://mascs.bz.cn/"
        # 隐形等待10秒时间
        self.wait(10)
        # 跳转网页
        self.driver.get(url)
        ...
        # # 使用匿名函数
        # wait.until(lambda diver: self.driver.find_element_by_class_name('phb'))
    ...
    def radio_click_pd(self, xpath, titname):
        # 定义点击单选框页面跳转及title判断的方法
        pages = self.driver.find_element_by_xpath(xpath)
        self.driver.execute_script("arguments[0].click();", pages)
