...
class PageTool(object):
    ...
    def downloader_msg(self, filename):  # 获取下载器md5，时间戳，数字签名
    ...
    def ele_clicks(self, driver, xpaths, now_whd, is_bt=0, is_judge_link=0, is_mix=0, pc_bt_xpath='', mo_bt_xpath='',
        ...
        for i in res:
            ...
            # WebDriverWait(driver, 10).until(EC.text_to_be_present_in_element((By.XPATH, '//*[@id="head_box"]/div/div[1]/p'), u'打包'))
            pg_tt = driver.title
